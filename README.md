...
$ wget https://urserver.kaist.ac.kr/publicdata/dynaVINS/d455_urban_robotics/loop_static.bag
$ wget https://urserver.kaist.ac.kr/publicdata/dynaVINS/d455_urban_robotics/loop_tempstatic.bag
```
* If direct download not works, download the dataset from : [Link](https://urserver.kaist.ac.kr:8148/sharing/Me4t2JZxg)
